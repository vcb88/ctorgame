...
import { useMultiplayerGameNew } from '../hooks/useMultiplayerGameNew';
...
export const GameNew: React.FC = () => {
  ...
  // Log component mount
  useEffect(() => {
    logger.debug('GameNew component mounted', { component: 'GameNew' });
    return () => {
      logger.debug('GameNew component unmounted', { component: 'GameNew' });
    };
  }, []);
