        ...
        <Card className="content">
          <div className="flex flex-col w-full h-full">
            ...
            <div className="flex justify-between items-center px-4 py-2 border-b">
              <h1 className="text-lg font-semibold">CTOR Game</h1>
              <div className="flex gap-4">
                <div className="flex items-center gap-2">
                  <Switch id="ai" checked={ai} onCheckedChange={setAi} className="scale-75" />
                  <Label htmlFor="ai" className="text-sm">AI Player 2</Label>
                </div>
                <div className="flex items-center gap-2">
                  <Switch id="map" checked={map} onCheckedChange={setMap} className="scale-75" />
